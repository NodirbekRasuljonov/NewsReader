                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(padding: const EdgeInsets.symmetric(vertical: 10.0),child: SizedBox(
                            child: Row(
                              children: [
                                Expanded(
                                  child: SizedBox(
                          ...
                          Expanded(child: Container(
                            ...
                            height: MediaQuery.of(context).size.height,
                            child: Text(widget.news.description.toString(),style: TextStyle(fontSize: MyFonts.medium),),
